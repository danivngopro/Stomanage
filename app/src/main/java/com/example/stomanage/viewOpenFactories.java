...
public class viewOpenFactories extends AppCompatActivity {
    ...
    private void printItems() {
        ...
        ValueEventListener valueEventListener = new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(viewOpenFactories.this, android.R.layout.simple_list_item_1,items);
